public class Match {
    ...
    public void start() {
        ...
        if (t1.getseek().isSuccessful()) {
            System.out.println("Team 1 wins with 150 points because they caught the snitch!");
        } else if (t2.getseek().isSuccessful()) {
            System.out.println("Team 2 wins with 150 points because they caught the snitch!");
        } else {
            if (t1goal > t2goal) {
